...
{-
When "n > length xs", "take n xs" and "drop n xs" returns "xs" and "[]" 
respectively.
ref:
 - https://hackage.haskell.org/package/base-4.14.1.0/docs/Prelude.html#v:take
...
isPalindrome (x:xs) = x == y && isPalindrome ys where
    ys = init xs
    y = last xs
-- or
