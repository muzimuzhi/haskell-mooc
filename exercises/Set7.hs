...
step WithEggs AddFlour = WithEggsAndFlour
step WithEggsAndFlour AddSugar = WithAll
step WithEggs AddSugar = WithEggsAndSuger
step WithEggsAndSuger AddFlour = WithAll
